...
Для автоматизации СВОИХ кошельков через персональные токены. Всё что делалось раньше парсингом сайта, теперь можно автоматизировать совершенно легально.
...
- [ ] Ваучеры
    - [ ] Активация
    - [ ] Создание
    - [ ] Получение информации о конкретном ваучере
        - [ ] Получение в RAW формате
        - [ ] Дата создания
        - [ ] Номинал
...
### Получение типа карты
Проверка типа карты по номеру карты.